...
public class DefinitionTextUtils {
    ...
    public static String definitionToDetail(IDefinition definition, ICompilerProject currentProject) {
        ...
        if (definition instanceof IClassDefinition) {
            ...
            IEffectDefinition effectDefinition = (IEffectDefinition) definition;
            detailBuilder.append("(effect) ");
            detailBuilder.append("[");
            detailBuilder.append(IMetaAttributeConstants.ATTRIBUTE_EFFECT);
            detailBuilder.append("(");
            detailBuilder.append(IMetaAttributeConstants.NAME_EFFECT_NAME);
            detailBuilder.append("=");
            detailBuilder.append("\"");
            detailBuilder.append(effectDefinition.getBaseName());
            detailBuilder.append("\"");
            detailBuilder.append(",");
            detailBuilder.append(IMetaAttributeConstants.NAME_EFFECT_EVENT);
            detailBuilder.append("=");
            detailBuilder.append("\"");
            detailBuilder.append(effectDefinition.getEvent());
            detailBuilder.append("\"");
            detailBuilder.append(")");
            detailBuilder.append("]");
