...
{
    public static final String REQUEST_COMMAND = "setBreakpoints";

    public SetBreakpointsRequest.SetBreakpointsArguments arguments;

    public class SetBreakpointsArguments extends RequestArguments
    {
