...
class ProjectUtilsTests
{
	...
	{
		String path = ProjectUtils.findAIRDescriptorOutputPath("src/Test.as", "src/Test-app.xml", "output", false, true);
	...
	{
		String path = ProjectUtils.findAIRDescriptorOutputPath("path/to/Test.as", "path/to/Test-app.xml", null, false, true);
	...
	{
		String path = ProjectUtils.findAIRDescriptorOutputPath("src/main/royale/Test.as", "src/main/royale/Test-app.xml", null, false, true);
		File file = new File(System.getProperty("user.dir"), "bin/js-debug/Test-app.xml");
		Assertions.assertEquals(file.toPath().toString(), path,
			"ProjectUtils.findAIRDescriptorOutputPath() returned incorrect value.");
	}
	...
	{
		String path = ProjectUtils.findAIRDescriptorOutputPath("src/main/flex/Test.as", "src/main/flex/Test-app.xml", null, false, true);
		File file = new File(System.getProperty("user.dir"), "bin/js-debug/Test-app.xml");
		Assertions.assertEquals(file.toPath().toString(), path,
			"ProjectUtils.findAIRDescriptorOutputPath() returned incorrect value.");
	}
	...
	{
		String path = ProjectUtils.findAIRDescriptorOutputPath("path/to/src/Test.as", "path/to/src/Test-app.xml", null, false, false);
	...
	{
		String path = ProjectUtils.findAIRDescriptorOutputPath("src/main/royale/Test.as", "src/main/royale/Test-app.xml", null, false, false);
		File file = new File(System.getProperty("user.dir"), "bin/js-release/Test-app.xml");
		Assertions.assertEquals(file.toPath().toString(), path,
			"ProjectUtils.findAIRDescriptorOutputPath() returned incorrect value.");
	}
	...
	{
		String path = ProjectUtils.findAIRDescriptorOutputPath("src/main/flex/Test.as", "src/main/flex/Test-app.xml", null, false, false);
		File file = new File(System.getProperty("user.dir"), "bin/js-release/Test-app.xml");
		Assertions.assertEquals(file.toPath().toString(), path,
			"ProjectUtils.findAIRDescriptorOutputPath() returned incorrect value.");
	}
	...
	void testFindApplicationContentForSWF()
	{
		...
		Assertions.assertEquals("Test.swf", path,
			"ProjectUtils.findApplicationContent() returned incorrect value.");
	}
	...
	void testFindApplicationContentForJS()
	{
		...
		Assertions.assertEquals("index.html", path,
			"ProjectUtils.findApplicationContent() returned incorrect value.");
	}
